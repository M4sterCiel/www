...
<!DOCTYPE html>
    ...
    <form method="POST" class="form_register_usr">
        ...
        <input id="reg-mail" type="email" name="email" placeholder="example@123.com" required><br>
        <label for="passwd">Password (UpperCase, LowerCase, Number/SpecialChar and min 8 Chars)</label><br>
